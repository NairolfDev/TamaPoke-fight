...
static const char *const STRINGS[LANG_COUNT][STR_COUNT] = {
  // ---------------- ES ----------------
  {
    ...
    "COMBATE", "FUE", "DEF", "VEL", "PES", "COMBATE LIBRE",
    "MUY EFICAZ!", "CRITICO!", "POCO EFICAZ", "SIN EFECTO", "AGOTADO", "HUIR", "COMBATE LISTO", "QUE OLVIDA?", "NO APRENDER",
  ...
  // ---------------- EN ----------------
  {
    ...
    "BATTLE", "ATK", "DEF", "SPD", "WGT", "FREE BATTLE",
    "SUPER EFFECTIVE!", "CRITICAL HIT!", "NOT VERY EFFECTIVE", "NO EFFECT", "EXHAUSTED", "FLEE", "BATTLE READY", "FORGET WHICH?", "DO NOT LEARN",
    "MEDALS %d/%d", "tap: back",
    "NAME:", "tap to go back",
    "FOOD", "JOY", "ENE", "HYG",
    "BEST %u",
  ...
  // ---------------- FR ----------------
  {
    ...
    "COMBAT", "ATQ", "DEF", "VIT", "PDS", "COMBAT LIBRE",
    "TRES EFFICACE!", "COUP CRITIQUE!", "PEU EFFICACE", "AUCUN EFFET", "EPUISE", "FUIR", "COMBAT PRET", "OUBLIER QUOI?", "NE PAS APPRENDRE",
  ...
  // ---------------- DE ----------------
  {
    ...
    "KAMPF", "ANG", "VER", "INI", "GEW", "FREIER KAMPF",
    "SEHR EFFEKTIV!", "VOLLTREFFER!", "NICHT SEHR EFFEKTIV", "KEIN EFFEKT", "ERSCHOEPFT", "FLUCHT", "KAMPF BEREIT", "WAS VERGESSEN?", "NICHT LERNEN",
  ...
  // ---------------- IT ----------------
  {
    ...
    "LOTTA", "ATT", "DIF", "VEL", "PES", "LOTTA LIBERA",
    "SUPEREFFICACE!", "BRUTTO COLPO!", "POCO EFFICACE", "NESSUN EFFETTO", "SFINITO", "FUGA", "LOTTA PRONTA", "COSA SCORDARE?", "NON IMPARARE",
  ...
  // ---------------- PT ----------------
  {
    ...
    "COMBATE", "ATQ", "DEF", "VEL", "PES", "COMBATE LIVRE",
    "SUPER EFICAZ!", "ACERTO CRITICO!", "POUCO EFICAZ", "SEM EFEITO", "EXAUSTO", "FUGIR", "COMBATE PRONTO", "ESQUECER QUAL?", "NAO APRENDER",
