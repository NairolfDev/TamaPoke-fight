...
static const char *const STRINGS[LANG_COUNT][STR_COUNT] = {
  // ---------------- ES ----------------
  {
    ...
    "MUY EFICAZ!", "CRITICO!", "POCO EFICAZ", "SIN EFECTO", "AGOTADO",
  ...
  // ---------------- EN ----------------
  {
    ...
    "SUPER EFFECTIVE!", "CRITICAL HIT!", "NOT VERY EFFECTIVE", "NO EFFECT", "EXHAUSTED",
    "MEDALS %d/%d", "tap: back",
    "NAME:", "tap to go back",
    "FOOD", "JOY", "ENE", "HYG",
    "BEST %u",
  ...
  // ---------------- FR ----------------
  {
    ...
    "TRES EFFICACE!", "COUP CRITIQUE!", "PEU EFFICACE", "AUCUN EFFET", "EPUISE",
  ...
  // ---------------- DE ----------------
  {
    ...
    "SEHR EFFEKTIV!", "VOLLTREFFER!", "NICHT SEHR EFFEKTIV", "KEIN EFFEKT", "ERSCHOEPFT",
  ...
  // ---------------- IT ----------------
  {
    ...
    "SUPEREFFICACE!", "BRUTTO COLPO!", "POCO EFFICACE", "NESSUN EFFETTO", "SFINITO",
  ...
  // ---------------- PT ----------------
  {
    ...
    "SUPER EFICAZ!", "ACERTO CRITICO!", "POUCO EFICAZ", "SEM EFEITO", "EXAUSTO",
