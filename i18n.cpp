...
static const char *const STRINGS[LANG_COUNT][STR_COUNT] = {
  // ---------------- ES ----------------
  {
    ...
    "MUY EFICAZ!", "CRITICO!", "POCO EFICAZ", "SIN EFECTO", "AGOTADO", "HUIR",
  ...
  // ---------------- EN ----------------
  {
    ...
    "SUPER EFFECTIVE!", "CRITICAL HIT!", "NOT VERY EFFECTIVE", "NO EFFECT", "EXHAUSTED", "FLEE",
    "MEDALS %d/%d", "tap: back",
    "NAME:", "tap to go back",
    "FOOD", "JOY", "ENE", "HYG",
    "BEST %u",
  ...
  // ---------------- FR ----------------
  {
    ...
    "TRES EFFICACE!", "COUP CRITIQUE!", "PEU EFFICACE", "AUCUN EFFET", "EPUISE", "FUIR",
  ...
  // ---------------- DE ----------------
  {
    ...
    "SEHR EFFEKTIV!", "VOLLTREFFER!", "NICHT SEHR EFFEKTIV", "KEIN EFFEKT", "ERSCHOEPFT", "FLUCHT",
  ...
  // ---------------- IT ----------------
  {
    ...
    "SUPEREFFICACE!", "BRUTTO COLPO!", "POCO EFFICACE", "NESSUN EFFETTO", "SFINITO", "FUGA",
  ...
  // ---------------- PT ----------------
  {
    ...
    "SUPER EFICAZ!", "ACERTO CRITICO!", "POUCO EFICAZ", "SEM EFEITO", "EXAUSTO", "FUGIR",
