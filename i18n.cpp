...
static const char *const STRINGS[LANG_COUNT][STR_COUNT] = {
  // ---------------- ES ----------------
  {
    ...
    "MUY EFICAZ!", "CRITICO!", "POCO EFICAZ", "SIN EFECTO", "AGOTADO", "HUIR", "COMBATE LISTO",
  ...
  // ---------------- EN ----------------
  {
    ...
    "SUPER EFFECTIVE!", "CRITICAL HIT!", "NOT VERY EFFECTIVE", "NO EFFECT", "EXHAUSTED", "FLEE", "BATTLE READY",
    "MEDALS %d/%d", "tap: back",
    "NAME:", "tap to go back",
    "FOOD", "JOY", "ENE", "HYG",
    "BEST %u",
  ...
  // ---------------- FR ----------------
  {
    ...
    "TRES EFFICACE!", "COUP CRITIQUE!", "PEU EFFICACE", "AUCUN EFFET", "EPUISE", "FUIR", "COMBAT PRET",
  ...
  // ---------------- DE ----------------
  {
    ...
    "SEHR EFFEKTIV!", "VOLLTREFFER!", "NICHT SEHR EFFEKTIV", "KEIN EFFEKT", "ERSCHOEPFT", "FLUCHT", "KAMPF BEREIT",
  ...
  // ---------------- IT ----------------
  {
    ...
    "SUPEREFFICACE!", "BRUTTO COLPO!", "POCO EFFICACE", "NESSUN EFFETTO", "SFINITO", "FUGA", "LOTTA PRONTA",
  ...
  // ---------------- PT ----------------
  {
    ...
    "SUPER EFICAZ!", "ACERTO CRITICO!", "POUCO EFICAZ", "SEM EFEITO", "EXAUSTO", "FUGIR", "COMBATE PRONTO",
